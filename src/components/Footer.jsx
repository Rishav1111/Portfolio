          ...
          <div className="flex-1 w-full">
            <form className="flex items-center justify-center">
              <input
                ...
                className="w-full p-1.5 rounded-l-lg bg-gray-800 border border-gray-600 focus:outline-none focus:border-blue-400"
              />
              <button
                type="submit"
                className="w-22 text-sm bg-gradient-to-r from-red-500 to-blue-600 text-white transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-r-lg"
              >
                Subscribe
              </button>
            </form>
